...
class Solver(object):
    ...
    def __init__(self, celeba_loader, rafd_loader, config):
        ...
        self.test_img_name = config.test_img_name
        self.test_img_attrs = config.test_img_attrs
        self.test_input_choice = config.test_input_choice
    ...
    def preprocess_test_img(self, input_img):
    ...
    def transform(self, point, center, scale, resolution, invert=False):
    ...
    def crop(self,image, center, scale, resolution=256):
    ...
    def test(self):
        ...
        with torch.no_grad():
            #for i, (x_real, c_org) in enumerate(data_loader):
                ...
                if (self.test_input_choice == 'text'):
                    print('TEXT>>>')
                    c_trg_m = [self.getAttrsFromText()]
                else:
                    print("ATTRS>>>")
